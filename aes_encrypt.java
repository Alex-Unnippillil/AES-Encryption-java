...
public class Aes {
  ...
  public static String encrypt(String plainText) throws Exception {
    ...
    byte[] cipherText = cipher.outputFinal(plainText.getBytes());
    ...
    return new String(new String(Base64.getEncoder().encode(cipherTextWithIvPrefix), StandardCharsets.UTF_8)); 
  }
  ...
  public static String decrypt(String cipherText) throws Exception {
    ...
    byte[] decryptedCipherText = cipher.outputFinal(base64decodedCipherText);
